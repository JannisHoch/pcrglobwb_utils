...
@click.option('--o_sum/--no-o_sum', default=False, help='can be set to compute monthly averages from totals for observed data - does not work with annual data.')
@click.option('--s_sum/--no-s_sum', default=False, help='can be set to compute monthly averages from totals for simulated data - does not work with annual data.')
