script='./evaluate_per_polygon.py'
...
python $script -o lwe_thickness -s total_thickness_of_water_storage -cf 100 -id watprovID --plot --anomaly $shp $sim $obs $out
...
python $script -o E -s total_evaporation -cf 1000 -id watprovID --sum --plot $shp $sim $obs $out